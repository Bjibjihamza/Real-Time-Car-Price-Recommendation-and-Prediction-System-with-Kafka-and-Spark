...
for fold, (train_idx, val_idx) in enumerate(kf.split(X_scaled)):
    ...
    history = model.fit(X_train, y_train, epochs=500, batch_size=32, validation_data=(X_val, y_val), callbacks=[early_stopping, reduce_lr, model_checkpoint], verbose=1)
...
final_history = final_model.fit(X_train_final, y_train_final, epochs=500, batch_size=32, validation_data=(X_val_final, y_val_final), callbacks=[early_stopping, reduce_lr, model_checkpoint], verbose=1)
